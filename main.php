...
.coverflow{
    ...
    animation: silder 5s linear infinite;
}
...
.triangle_right{
  ...
  border-left:24px solid #fc3;
}
.triangle_left{
  width:0px;
  height:0px;
  border-top:12px solid transparent;
  border-right:24px solid #fc3;
  border-bottom:12px solid transparent;
	...
	<div class="half" style="vertical-align:top;">
      ...
      <div class="rb tab" style="width:95%;">
        <div id="abgne-block-20111227">			
			<div id='bigName' class="ct"><?=$pvName[0]?></div>
			<div id='bigPic' class="coverflow">
			<!-- <div class="coverflow"> -->
			<!-- <div class="pvMovein"> -->
			<!-- <div class="pvEnlarge"> -->
				<img id='bigPic1' style="width:200px;" src="<?=$pvPic[0]?>">
			</div>				
...
function update(){			
	if(seq>=tcnt || seq==0){ 
		...
		$("#leftA").hide();
		$("#rightA").show();
		document.getElementById("bigPic1").src = pic[0];
		...
		$("#leftA").show();
		$("#rightA").hide();
		document.getElementById("bigPic1").src = pic[seq];
